...
import { isAgentPaneDisconnected, StatusDot } from './StatusDot'
  ...
  return (
    ...
    >
      ...
      >
        ...
        {isAgent && <StatusDot status={pane.agentStatus?.status ?? 'idle'} detail={pane.agentStatus?.detail} disconnected={isAgentPaneDisconnected(pane)} />}
      </span>
